...
public class UpdateHistoryAdapter extends RecyclerView.Adapter<UpdateHistoryAdapter.TasksViewHolder> {
    private Context mCtx;
    private List<HistoryTable> myassign;

    public UpdateHistoryAdapter(Context mCtx, List<HistoryTable> myassign) {
        this.mCtx = mCtx;
        this.myassign = myassign;
    }

    @Override
    public UpdateHistoryAdapter.TasksViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mCtx).inflate(R.layout.history_recycler, parent, false);
        return new UpdateHistoryAdapter.TasksViewHolder(view);
    }

    @Override
    public void onBindViewHolder(UpdateHistoryAdapter.TasksViewHolder holder, int position) {
    ...
    class TasksViewHolder extends RecyclerView.ViewHolder {
        ...
        void showData(HistoryTable myproduct){
            if(myproduct!=null){
                tvhistoryTime.setText(myproduct.getUpdate_date());
